...
use BotMan\Drivers\Telegram\Console\Commands\TelegramRegisterCommand as TelegramCommand;

class TelegramRegisterCommand extends TelegramCommand
{
    /**
    ...
    public function handle()
    {
        ...
        if (!$remove) {
            $url .= '?url=' . $this->ask('What is the target url for the telegram bot?') . '/telegram';
        }
